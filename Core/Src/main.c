...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, WR_Pin|RS_Pin|CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, D0_Pin|D1_Pin|D2_Pin|D3_Pin
                          |D4_Pin|D5_Pin|D6_Pin|D7_Pin
                          |test_git_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, XPT_CS_Pin|RD_Pin|RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : WR_Pin RS_Pin CS_Pin */
  GPIO_InitStruct.Pin = WR_Pin|RS_Pin|CS_Pin;
  ...
  /*Configure GPIO pins : XPT_CS_Pin RD_Pin RST_Pin */
  GPIO_InitStruct.Pin = XPT_CS_Pin|RD_Pin|RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void keypad2(void)
{
  ...
  HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_12);   /// change by naveen
}
